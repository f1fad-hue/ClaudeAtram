...
| VIX | **14.87 (22 Sep)**, +0.41%, flat through the UN week. One source gave 16.34 — the 2 SEP close already in this series, which would be +10% on a flat S&P; discarded. 14.87 is corroborated BACKWARDS: a live quote on the 23rd showed 14.25 "down 4.17%", and 14.25 / (1 − 0.0417) = 14.87 | P | market reporting 22–23 Sep (verified via search result) | 2026-09-23 |
...
| US 10-year Treasury yield | **4.97% (22 Sep close)**, +1bp. Official closes: 4.94% (17th) · 5.01% (18th) · 4.96% (21st) · 4.97% (22nd). Intraday peak 5.04% on 15 Sep — a 19-year high, and **that** is the figure "highest since 2007" belongs to | P | Treasury daily par curve / Fed H.15 / FRED DGS10 (verified via search result) | 2026-09-23 |
...
| US 2-year Treasury yield | **~4.743% (22 Sep, mid-session)**, −1bp. **Was 4.63% from 11 Sep, 12 days stale and unchecked**: the lag bound added on 21 Sep listed the 10- and 30-year and missed the 2-year, which had no date field at all. Labelled mid-session — no official close was found | P | CNBC 22 Sep (verified via search result) | 2026-09-23 |
| US 30-year Treasury yield | **~5.296% (22 Sep, mid-session)**, flat. The 21 Sep "5.284% close" was also a 3dp mid-session print. A second, stale 30-year row (5.36%, 11 Sep) sat in this register alongside the current one until 2026-09-23 and has been removed | P | CNBC 22 Sep (verified via search result) | 2026-09-23 |
...
| USD/PHP | **62.780 — 21 Sep close**, −3.1 centavos from 62.749; chains exactly. The peso came off its record and is drifting back: 62.86 on 14 Sep is the weakest close, 62.925 on the 15th the weakest intraday. Spot and the record are separate inputs | P | radar.ph 21 Sep; Manila Times 18 Sep; GMA News 14 Sep; BusinessWorld 16 Sep | 2026-09-23 |
| USD/PHP 22 Sep | **HELD at 21 Sep.** The peso rebounded on the 22nd on the US–Iran talks (BusinessWorld), but the only level found was "shed 3.9 centavos to P62.625, a new all-time low" — **the 8 Sep record, pasted under Tuesday's date.** It contradicts "rebounded", is not a record against 62.86, and 62.78 + 0.039 ≠ 62.625 | — | arithmetic chain rule | 2026-09-23 |
| PSEi | **5,814.56 (22 Sep)**, −29.23 points (−0.50%), a third down session. Chains: 5,814.56 + 29.23 = 5,843.79, exactly the 21 Sep close | P | BusinessWorld 22–23 Sep (verified via search result) | 2026-09-23 |
...
| Brent crude | **$99.25 — 22 Sep settle**, −1.09% on the day, a fifth straight down session, 8.7% off the $108.75 high of 15 Sep. Prior settle **$100.34 (21 Sep), recovered by the chain** — see the 21 Sep oil row | P | CNBC 22 Sep (verified via search result) | 2026-09-23 |
| WTI crude | **$94.59 — 22 Sep settle**, −1.2% on the day; prior **$95.78 (21 Sep)**, recovered by the same chain | P | CNBC 22 Sep (verified via search result) | 2026-09-23 |
| Brent y/y change | +51.53% | D | derived from the $99.25 settle against a $65.50 year-ago base, itself implied by the last verified pair ($96.28 at +46.99%) | 2026-09-23 |
...
| **Rates and energy tilt transmission** | tilt = (typed tilt at calibration) × (driver − 5.5) / (driver at calibration − 5.5). Calibrated at the readings in force when the tilts were first written — **Monetary 4.0, Geopolitics 2.5 (commit 918c280, 2 Sep)** — so the calibration states the ORIGINAL judgment rather than a new one. Today: rates ×2.167, energy ×1.333 | **added 2026-09-23. Until then these tilts were typed constants and no driver move ever reached a fund.** Monetary moved 4.0 → 3.5 → 2.5 → 2.25 and Geopolitics 2.5 → 1.5 → 1.0 → 1.5 → 1.25 → 1.5 while Global Tech's rates tilt stayed −0.40 and energy −0.15. The page said the optimiser was built from the macro drivers; checklist item 15 checked only that the WORDS were on the page. Linear in distance from neutral is the minimal assumption and is stated as one. Effect: Global Tech 7.77% → 7.25%, cash 4.60% → 4.91%, optimised 7.48% → 7.39% — **allocation unchanged at 15/50/30/5** |
