...
| **21 Sep oil session** | **WITHHELD.** Every source agrees crude fell a fourth session on UN General Assembly diplomacy, on the Petroline closure being read as less disruptive than feared, and on Hormuz flows proving resilient. None agrees where it settled: Brent is reported at **100.06 (−3.67%), 100.34 (−3.4%), 101.40 (−$2.51) and 101.5 (−2.3%)**; WTI at 95.78, 97.56, 97.86 and 97.9. Each chains off the 18th by its own percentage, so the chain rule cannot adjudicate. The Brent–WTI spread favours the ~101.4/97.86 pair (3.54 against Friday's 3.57, versus 4.56 and 2.50 for the others) — one structural argument against two sources, which is not enough to publish a settle by | — | arithmetic chain rule + spread sanity check | 2026-09-21 |
| VIX | **14.81 (21 Sep)**, −4.08% — and 15.44 × (1 − 0.0408) = 14.81 exactly. Below where spot sat before the 10 Sep break | P | market reporting 21 Sep (verified via search result) | 2026-09-21 |
...
| US 10-year Treasury yield | **4.951% (21 Sep close)**, −4.3bp as oil fell and global borrowing costs eased. Series: 5.016% (16th) · 4.94% (17th) · **18th WITHHELD** · 4.951% (21st). Intraday peak 5.04% on 15 Sep — a 19-year high, and **that** is the figure "highest since 2007" belongs to | P | CNBC 2026-09-21 "Treasury yields ease as global borrowing costs tumble"; Federal Reserve H.15 for the 17th | 2026-09-21 |
| **↑ DATING ERROR, published for two days** | **4.94% is the SEVENTEENTH's close, not the eighteenth's.** The Fed's own H.15 gives 4.94% for 17 Sep, and CNBC has the 10-year falling "more than 7 basis points" that day after the hike. Friday the 18th went the OTHER way, rising 5–7bp to hover near 5%. The model published 4.94% as the 18th from 2026-09-19 and built "the rate leg eased too" on top of it | — | **Caught by the chain**: Monday's 4.951%, down "more than 4 basis points", backs out to a Friday near 4.99% — which 4.94% cannot produce. Third instance of this failure mode after the 15 Sep VIX print and the 14 Sep equity figures | 2026-09-21 |
| 18 Sep 10-year close | **WITHHELD.** Every source agrees the yield ROSE; they disagree on where it landed — 4.99%, 5.00% and 5.01% are all reported. A level nobody agrees on is not a level | — | arithmetic chain rule | 2026-09-21 |
| US 30-year Treasury yield | **5.284% (21 Sep)**, also more than 4bp lower — was 5.36% from 11 Sep and ten days stale | P | CNBC 2026-09-21 | 2026-09-21 |
...
| **UN General Assembly** | Trump addresses the UNGA **22 Sep**, weighing what he has called a "big decision" on new strikes against Iran's government while also saying he is open to talking; **Pezeshkian speaks 23 Sep**. Interaction between the delegations is neither scheduled nor ruled out. Both are pending catalysts now | P | CNBC / ABC / NPR 21 Sep (verified via search result) — the market priced the de-escalation reading on 21 Sep; this page prices neither outcome | 2026-09-21 |
...
| USD/PHP | **62.780 — 21 Sep close**, −3.1 centavos from 62.749; chains exactly. The peso came off its record and is drifting back: 62.86 on 14 Sep is the weakest close, 62.925 on the 15th the weakest intraday. Spot and the record are separate inputs | P | radar.ph 21 Sep; Manila Times 18 Sep; GMA News 14 Sep; BusinessWorld 16 Sep | 2026-09-21 |
| PSEi | **5,843.79 (21 Sep)**, −12.12 points (−0.21%), a second down session. Chains: 5,843.79 + 12.12 = 5,855.91, exactly the 18 Sep close | P | radar.ph 21 Sep | 2026-09-21 |
...
| VIX futures strip is NOT re-quoted | curve still on its 4 Sep quote date — **17 days**, eleventh consecutive day of searching without a fresh strip | — | every source found still echoes the same 4 Sep levels; the curve stays on 4 Sep and the 1.12-point spot divergence is published. **Now bounded rather than merely disclosed**: a check fails once the strip passes one 30-day roll window, because at that point the front contract it was quoted against has settled | 2026-09-19 |
